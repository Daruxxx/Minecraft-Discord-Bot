...
import me.darux.spacebot.api.SpaceBotApi;
...
public class SpaceBotMain extends JavaPlugin {
...
List<String> sync=new ArrayList<String>();
    ...
    public void registrarComandos() {
        this.getCommand("spacebot").setExecutor(new me.darux.spacebot.Minecraft.commands.SpaceBot(this));
    ...
    public SpaceBotApi getApi(){
        SpaceBotApi api=new SpaceBotApi(this);
        return  api;
    }
